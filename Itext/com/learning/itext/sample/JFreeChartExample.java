/*
 * $Id: JFreeChartExample.java,v 1.4 2005/06/02 11:05:39 blowagie Exp $
 * $Name:  $
 *
...
public class JFreeChartExample {
	...
	public static void main(String[] args) {
		...
		convertToPdf(getBarChart(), 400, 600, "C:\\home\\appoutput\\itext\\barchart.pdf");
		convertToPdf(getPieChart(), 400, 600, "C:\\home\\appoutput\\itext\\piechart.pdf");
		convertToPdf(getXYChart(), 400, 600, "C:\\home\\appoutput\\itext\\xychart.pdf");
	}
    ...
    public static void convertToPdf(JFreeChart chart, int width, int height, String filename) {
    	...
    	try {
    		...
    		Rectangle2D r2d = new Rectangle2D.Double(0, 0, width/2, height/2);
    		chart.draw(g2d, r2d);
    		g2d.dispose();
